      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap md:text-left text-center order-first">
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4 mb-10 md:mb-0">
            ...
            <nav className="list-none mb-10">
              <li className="mb-2">
                <Link to="/destination/Rajasthan" className="text-gray-400 hover:text-white transition-colors duration-300">Rajasthan</Link>
              </li>
              <li className="mb-2">
                <Link to="/destination/Kerala" className="text-gray-400 hover:text-white transition-colors duration-300">Kerala</Link>
              </li>
              <li className="mb-2">
                <Link to="/destination/Goa" className="text-gray-400 hover:text-white transition-colors duration-300">Goa</Link>
              </li>
              <li className="mb-2">
                <Link to="/destination/HimachalPradesh" className="text-gray-400 hover:text-white transition-colors duration-300">Himachal Pradesh</Link>
              </li>
            </nav>
          </div>
      ...
      <div className="bg-black">
        <div className="container mx-auto py-6 px-5 flex flex-wrap flex-col sm:flex-row">
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            ...
            <a href="https://www.instagram.com/premdhote17/" target='_blank' className="ml-3 text-gray-400 hover:text-white transition-colors duration-300">
              <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
                <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
              </svg>
            </a>
            <a href="https://www.linkedin.com/in/premveddhote/" target='_blank' className="ml-3 text-gray-400 hover:text-white transition-colors duration-300">
