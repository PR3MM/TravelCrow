      ...
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex flex-wrap -m-4">
          <div className="p-4 md:w-1/2 w-full">
            <div className="h-full bg-gray-900 bg-opacity-80 p-8 rounded">
              <svg
              ...
              <a className="inline-flex items-center">
                ...
                <span className="flex-grow flex flex-col pl-4">
                  ...
                  <span className="text-gray-400 text-sm">Travel Enthusiast</span>
                </span>
              </a>
            </div>
          </div>
            ...
            <div className="h-full bg-gray-900 bg-opacity-80 p-8 rounded">
              ...
              <a className="inline-flex items-center">
                ...
                <span className="flex-grow flex flex-col pl-4">
                  ...
                  <span className="text-gray-400 text-sm">Frequent Traveler</span>
                </span>
              </a>
            </div>
          </div>
