        ...
        <form action="#" class="mt-8 grid grid-cols-6 gap-6">
          ...
          <div class="col-span-6">
            ...
            <input
              ...
              id="Email"
              name="email"
              class="mt-1 w-5/12 rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
            />
          </div>
          ...
          <div class="col-span-6 sm:col-span-3">
            ...
            <input
              ...
              id="Password"
              name="password"
              class="mt-1 w-10/12 rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
            />
          </div>
          ...
          <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
            ...
            <p class="mt-4 text-sm text-gray-500 sm:mt-0 dark:text-gray-400">
              ...
              <Link to="/signup" class="text-gray-700 underline dark:text-gray-200">Create an Account</Link>.
            </p>
          </div>
        </form>
      </div>
