...
function Login() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setError(error.message || "Failed to Login"); // Display specific error messages if available
    }
    setLoading(false);
  }
        ...
        <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
          ...
          <main class="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
            <div class="max-w-xl lg:max-w-3xl">
              ...
              {error && <p class=" mt-5 text-red-500 font-bold">{error}</p>}
              ...
              >
                ...
                <div class="col-span-6">
                  ...
                  <input
                    ...
                    id="Email"
                    name="email"
                    class="mt-1 w-72 rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 "
                    ref={emailref}
                  />
                </div>
